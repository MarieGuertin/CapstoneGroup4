...
#ifndef AI_CNN_MODEL_H
#define AI_CNN_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_CNN_MODEL_MODEL_NAME          "cnn_model"
#define AI_CNN_MODEL_ORIGIN_MODEL_NAME   "cnn"

/******************************************************************************/
#define AI_CNN_MODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_CNN_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_CNN_MODEL_IN \
  ai_cnn_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_MODEL_IN_SIZE { \
  AI_CNN_MODEL_IN_1_SIZE, \
}
#define AI_CNN_MODEL_IN_SIZE_BYTES { \
  AI_CNN_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_CNN_MODEL_IN_1_HEIGHT      (49)
#define AI_CNN_MODEL_IN_1_WIDTH       (10)
#define AI_CNN_MODEL_IN_1_CHANNEL     (1)
#define AI_CNN_MODEL_IN_1_SIZE        (49 * 10 * 1)
#define AI_CNN_MODEL_IN_1_SIZE_BYTES  (1960)

/******************************************************************************/
#define AI_CNN_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CNN_MODEL_OUT \
  ai_cnn_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_MODEL_OUT_SIZE { \
  AI_CNN_MODEL_OUT_1_SIZE, \
}
#define AI_CNN_MODEL_OUT_SIZE_BYTES { \
  AI_CNN_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_CNN_MODEL_OUT_1_CHANNEL     (12)
#define AI_CNN_MODEL_OUT_1_SIZE        (12)
#define AI_CNN_MODEL_OUT_1_SIZE_BYTES  (48)

/******************************************************************************/
#define AI_CNN_MODEL_N_NODES (9)
 ...
 * @ref ai_cnn_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_cnn_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CNN_MODEL_*
 * defines into file @ref cnn_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cnn_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CNN_MODEL_H */
